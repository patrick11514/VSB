const searchBox = document.querySelector('input#search') as HTMLInputElement
const result = document.querySelector('div#results') as HTMLDivElement

let promise: number | undefined = undefined
