...
//! TODO (4p): implement a sparse memory map
...
//!
//! Implement two methods, `read` and `write`, on the [MemoryMap] data structure below.
...
//!
//! Note: most tests will pass even without defragmentation. You can start without it to make your
//! life easier, and then add it once the rest of the code is working.
...
mod tests {
    ...
    fn read_high_end() {
        ...
        assert_eq!(
            map.read(50000, 8),
            Some(vec![70, 71, 72, 73, 74, 75, 76, 77])
        );
    }
