...
void ShaderStorage::addShaderProgram(const std::string &name, ShaderProgram &shader)
{
...
const ShaderProgram &ShaderStorage::getShaderProgram(const std::string &name) const
{
    auto it = this->shaders.find(name);
