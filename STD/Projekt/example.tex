...
\begin{align}
    \lim_{n\to\infty} \frac{n!}{2^n} &= \lim_{n\to\infty} \frac{\sqrt{2\pi n} (\frac{n}{e})^n}{2^n} \\
...
Tělem atrakce dříve pracovníci hloubce
