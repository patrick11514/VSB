...
const float planeNormal[32]{
    -1.0f, 0.0f, 1.0f,  0.f, 1.f, 0.f, 0.f, 1.f, // Top Left
    1.0f,  0.0f, 1.0f,  0.f, 1.f, 0.f, 1.f, 1.f, // Top Right
    1.0f,  0.0f, -1.0f, 0.f, 1.f, 0.f, 1.f, 0.f, // Bottom Right
    -1.0f, 0.0f, -1.0f, 0.f, 1.f, 0.f, 0.f, 0.f, // Bottom Left
};
